...
with open(r"E:\Crop Recomm\crop-recommendation-project\model.pkl", "rb") as f:
    model = pickle.load(f)
with open(r"E:\Crop Recomm\crop-recommendation-project\standscaler.pkl", "rb") as f1:
    sc = pickle.load(f1)
with open(r"E:\Crop Recomm\crop-recommendation-project\minmaxscaler.pkl", "rb") as f2:
    ms = pickle.load(f2)
